  ...
  <div class=" relative" v-else id="app">
    ...
    <section class="text-center mt-20">
      ...
      <div class="mt-9 flex justify-center space-x-4 ">
        <a href="https://github.com/Tapiwa-1/resume/blob/main/resume/assets/resume.pdf"  class="bg-green-600 text-white px-6 py-2 rounded-md shadow hover:bg-green-700 transition duration-300">
            Download CV
        </a>
